...
var result = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var type, keyword, stringSlug, keyWordSlugRegex, keyWordRegex, songsDetail, songs, _i, songs_1, item, singer;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                type = req.params.type;
                keyword = "".concat(req.query.keyword);
                stringSlug = (0, convertToSlug_1.convertToSlug)(keyword);
                keyWordSlugRegex = new RegExp(stringSlug, "i");
                keyWordRegex = new RegExp(keyword, "i");
                songsDetail = [];
                if (!keyword) return [3, 5];
                return [4, song_model_1.default.find({
                        $or: [
            ...
            case 1:
                ...
                _a.label = 2;
            case 2:
                if (!(_i < songs_1.length)) return [3, 5];
                item = songs_1[_i];
