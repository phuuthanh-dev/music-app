...
var fovorite_song_model_1 = __importDefault(require("../../models/fovorite-song.model"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, topic_model_1.default.findOne({ slug: slugTopic, deleted: false, status: "active" })];
            case 1:
                topic = _a.sent();
                return [4, song_model_1.default.find({ topicId: topic.id, deleted: false, status: "active" })];
            case 2:
                songs = _a.sent();
                _i = 0, songs_1 = songs;
                _a.label = 3;
            case 3:
                if (!(_i < songs_1.length)) return [3, 6];
                item = songs_1[_i];
                return [4, singer_model_1.default.findOne({
                        _id: item.singerId,
                        deleted: false
                    }).select("fullName")];
            case 4:
...
var detail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var slugSong, song, topic, singer, favoriteSong, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                slugSong = req.params.slugSong;
                return [4, song_model_1.default.findOne({ slug: slugSong, deleted: false, status: "active" })];
            case 1:
                song = _a.sent();
                return [4, topic_model_1.default.findOne({ _id: song.topicId, deleted: false, status: "active" }).select("title")];
            case 2:
                topic = _a.sent();
                return [4, singer_model_1.default.findOne({ _id: song.singerId, deleted: false }).select("fullName")];
            case 3:
                singer = _a.sent();
                return [4, fovorite_song_model_1.default.findOne({ userId: "", songId: song.id })];
            case 4:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, song_model_1.default.findOne({
            ...
            case 1:
                ...
                return [4, song_model_1.default.updateOne({
                        _id: req.params.songId,
                        deleted: false,
                        status: "active"
                    }, {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                favoriteSong = new fovorite_song_model_1.default({
                    userId: "",
                    songId: songId
                });
                return [4, favoriteSong.save()];
            case 1:
                _a.sent();
                return [3, 4];
            case 2: return [4, fovorite_song_model_1.default.deleteOne({
                    userId: "",
                    songId: songId
                })];
            case 3:
...
var favorite = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, fovorite_song_model_1.default.find({
                    userId: ""
                })];
            case 1:
                ...
                _a.label = 2;
            case 2:
                if (!(_i < favoriteSongs_1.length)) return [3, 6];
